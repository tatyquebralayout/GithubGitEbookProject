      ...
      <table className="gh-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Mostra o histórico de todas as referências (HEAD, branches) no repositório. Útil para recuperar commits perdidos.</td>
          ...
          <tr>
            ...
            <td>Realiza uma busca binária no histórico de commits para encontrar o commit que introduziu um bug.</td>
          ...
          <tr>
            ...
            <td>Salva temporariamente alterações não commitadas para limpar o diretório de trabalho.</td>
