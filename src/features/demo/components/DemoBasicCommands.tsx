      ...
      <table className="gh-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="font-mono text-xs">git clone https://github.com/usuario/repositorio.git</td>
            <td><AuthorProfilesDemo /></td>
            <td><ChallengeBadgeDemo type="beginner" text="Iniciante" /></td>
          </tr>
          <tr>
            <td className="font-mono">git add</td>
            <td>Adiciona alterações de arquivos do diretório de trabalho para a área de staging.</td>
          ...
          <tr>
            ...
            <td>Salva as alterações da área de staging permanentemente no histórico do repositório.</td>
            <td className="font-mono text-xs">git commit -m "feat: adiciona nova funcionalidade X"</td>
            <td><AuthorProfilesDemo /></td>
            <td><ChallengeBadgeDemo type="beginner" text="Iniciante" /></td>
          </tr>
          <tr>
            <td className="font-mono">git status</td>
            <td>Mostra o estado atual dos arquivos no diretório de trabalho e na área de staging.</td>
