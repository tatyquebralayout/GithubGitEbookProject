      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <div className="mt-8 flex justify-center space-x-4">
            ...
            <a href="#" aria-label="X (anteriormente Twitter)" className="text-white/80 hover:text-white transition-colors">
            ...
            <a href="#" aria-label="E-mail" className="text-white/80 hover:text-white transition-colors">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Referência Interativa</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Foco no Aprendizado</h3>
              <p className="text-gray-600">
              Sapien in monti palavris qui num significa nadis i pareci latim.
              </p>
            </div>
            ...
            <div className="space-y-8">
              <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">Desenvolvedora Líder no Projeto GitSheet</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">Engenheira de Software Sênior</h3>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Adoraria ouvir sobre seus projetos, ideias ou apenas bater um papo sobre tecnologia. 
            Não hesite em entrar em contato!
          </p>
          <a
            href="mailto:tatiana.barros@example.com"
            className="bg-white text-blue-600 font-semibold px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors text-lg"
          >
            Entre em Contato
          </a>
        </div>
