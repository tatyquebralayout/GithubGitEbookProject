      ...
      const renderDiagram = async () => {
        ...
        mermaid.initialize({
          ...
          themeVariables: {
            ...
            // Branch label colors
            ...(config.customColors?.branchLabel0 && {
              gitBranchLabel0: config.customColors.branchLabel0,
            }),
            ...(config.customColors?.branchLabel1 && {
              gitBranchLabel1: config.customColors.branchLabel1,
            }),
            ...(config.customColors?.branchLabel2 && {
              gitBranchLabel2: config.customColors.branchLabel2,
            }),
            ...(config.customColors?.branchLabel3 && {
              gitBranchLabel3: config.customColors.branchLabel3,
            }),

            // Commit styling
            ...(config.customColors?.commitLabel && {
              commitLabelColor: config.customColors.commitLabel,
            }),
            ...(config.customColors?.commitBg && {
              commitLabelBackground: config.customColors.commitBg,
            }),
            ...(config.customColors?.commitFontSize && {
              commitLabelFontSize: config.customColors.commitFontSize,
            }),
            ...
            ...(config.customColors?.tagBorder && {
              tagLabelBorder: config.customColors.tagBorder,
            }),
            ...(config.customColors?.tagFontSize && {
              tagLabelFontSize: config.customColors.tagFontSize,
            }),

            // Highlight commit colors
            ...(config.customColors?.highlightCommit0 && {
              gitInv0: config.customColors.highlightCommit0,
            }),
            ...(config.customColors?.highlightCommit1 && {
              gitInv1: config.customColors.highlightCommit1,
            }),
            ...(config.customColors?.highlightCommit2 && {
              gitInv2: config.customColors.highlightCommit2,
            }),
            ...(config.customColors?.highlightCommit3 && {
              gitInv3: config.customColors.highlightCommit3,
            }),
          },
        });
        ...
        try {
          ...
          const { svg } = await mermaid.render(
            `gitgraph-${id}`,
            buildDefinition(formattedDefinition)
          );
